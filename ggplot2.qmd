...
```{r}
library(ggimage)
admissions <- read.csv("https://raw.githubusercontent.com/biancaschutz/referenceR/refs/heads/main/ggimage_example/admissions.csv") %>%
...
R has hundreds of named colors which can be accessed with `colors()` and you can also use any hex code like `#FF0000`. See this [cheat sheet](https://www.nceas.ucsb.edu/sites/default/files/2020-04/colorPaletteCheatsheet.pdf) for more information about choosing colors, or [this guide](color.qmd) I wrote based on lectures from my UT data visualization class.
